...
ALTER TABLE tb_categoria CHANGE tipo_categoria area_curso VARCHAR(255);

INSERT INTO tb_curso (nome_curso, certificado, tempo_duracao, fk_tb_categoria)
VALUES
...
("Geografia", TRUE, "200:00:00",4),
("Pscicologia", TRUE, "400:00:00",3);

SELECT * FROM tb_curso WHERE tempo_duracao >500; 

package com.Farmacia.famarciamagica.controller;
...
import com.Farmacia.famarciamagica.repository.ProdutoRepository;
...
public class ProdutoController {
	...
	public ResponseEntity<Produto> post(@RequestBody Produto nome) {
		return ResponseEntity.status(201).body(repositoryP.save(nome));

	}

	@PutMapping
	public ResponseEntity<Produto> put(@RequestBody Produto nome) {
		return ResponseEntity.status(200).body(repositoryP.save(nome));
	}
